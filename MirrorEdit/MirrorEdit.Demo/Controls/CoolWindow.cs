...
using MirrorEdit.Demo.Util;
using System;

namespace MirrorEdit.Demo.Controls
{
    public class CoolWindow : Window, IStyleable
    {
        public static readonly AvaloniaProperty<Control> TitleBarContentProperty =
            AvaloniaProperty.Register<CoolWindow, Control>(nameof(TitleBarContent));
        ...
        Type IStyleable.StyleKey => typeof(CoolWindow);
