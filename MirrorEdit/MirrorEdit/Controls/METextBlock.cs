...
// Copyright (c) 0xFireball. All rights reserved.
...
namespace MirrorEdit.Controls
{
    ...
    /// </summary>
    public class METextBlock : Control
    {
        /// <summary>
        /// Defines the <see cref="Background"/> property.
        /// </summary>
        public static readonly StyledProperty<IBrush> BackgroundProperty =
            Border.BackgroundProperty.AddOwner<METextBlock>();
        ...
        public static readonly AttachedProperty<string> FontFamilyProperty =
            AvaloniaProperty.RegisterAttached<METextBlock, Control, string>(
                nameof(FontFamily),
        ...
        public static readonly AttachedProperty<double> FontSizeProperty =
            AvaloniaProperty.RegisterAttached<METextBlock, Control, double>(
                nameof(FontSize),
                defaultValue: 12,
                inherits: true);
        ...
        public static readonly AttachedProperty<FontStyle> FontStyleProperty =
            AvaloniaProperty.RegisterAttached<METextBlock, Control, FontStyle>(
                nameof(FontStyle),
                inherits: true);
        ...
        public static readonly AttachedProperty<FontWeight> FontWeightProperty =
            AvaloniaProperty.RegisterAttached<METextBlock, Control, FontWeight>(
                nameof(FontWeight),
                inherits: true,
        ...
        public static readonly AttachedProperty<IBrush> ForegroundProperty =
            AvaloniaProperty.RegisterAttached<METextBlock, Control, IBrush>(
                nameof(Foreground),
        ...
        /// </summary>
        public static readonly DirectProperty<METextBlock, string> TextProperty =
            AvaloniaProperty.RegisterDirect<METextBlock, string>(
                nameof(Text),
                o => o.Text,
                (o, v) => o.Text = v);
        ...
        public static readonly StyledProperty<TextAlignment> TextAlignmentProperty =
            AvaloniaProperty.Register<METextBlock, TextAlignment>(nameof(TextAlignment));

        /// <summary>
        /// Defines the <see cref="TextWrapping"/> property.
        /// </summary>
        public static readonly StyledProperty<TextWrapping> TextWrappingProperty =
            AvaloniaProperty.Register<METextBlock, TextWrapping>(nameof(TextWrapping));
        ...
        static METextBlock()
        {
            ClipToBoundsProperty.OverrideDefaultValue<METextBlock>(true);
